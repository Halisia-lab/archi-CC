...
public final class Member implements Entity<MemberId> {
    ...
    public static Member of(MemberId memberId, String lastname, String firstname, String email, String password, Address address) {
        final List<DomainEvent> recordedEvents = new ArrayList<>();
        recordedEvents.add(new CreateMemberEvent(memberId, lastname, firstname, email, password, address));
